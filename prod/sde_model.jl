...
defaultAgg = QuoteAggregator(Dict{DataType, Union{Nothing, PriceQuote}}(LastTick=>nothing, BidTick=>nothing), logger("strategy"), DEFAULT_REQUEST_MANAGER, lambda(Dict; on_next=(d)->println(d)))
